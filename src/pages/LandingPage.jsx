        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-20 items-center">
            ...
            <div className="flex items-center space-x-6">
              ...
              <Link
                to="/register/student"
                className="bg-blue-600 text-white px-6 py-2.5 rounded-lg font-bold hover:bg-blue-700 shadow-lg active:scale-95 transition-all"
              >
                Enroll Now
              </Link>
            </div>
      ...
      <section className="bg-slate-50 pt-20 pb-32 overflow-hidden relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <h1 className="text-5xl md:text-7xl font-extrabold text-slate-900 tracking-tight mb-6 leading-tight">
            ...
            <span className="text-blue-600">to Corporate Success.</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link
              to="/register/student"
              className="flex items-center justify-center gap-2 bg-slate-900 text-white px-8 py-4 rounded-xl font-bold text-lg hover:bg-slate-800 transition-all shadow-xl active:scale-95"
            >
              I am a Student <ArrowRight className="w-5 h-5" />
            </Link>
            <Link
              to="/register/company"
              className="flex items-center justify-center gap-2 bg-white border-2 border-slate-200 text-slate-900 px-8 py-4 rounded-xl font-bold text-lg hover:border-blue-600 hover:text-blue-600 transition-all active:scale-95"
            >
              Hiring Partner
            </Link>
          </div>
