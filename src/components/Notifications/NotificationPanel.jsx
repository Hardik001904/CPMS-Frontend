 ...
 *
 * UPDATE: passes onNavigate={onClose} to each NotificationItem so the
 * panel closes automatically when the user clicks a navigable notification.
 */
          ...
          <>
            {notifications.map((notification) => (
              <NotificationItem
                ...
                onNavigate={onClose} // ← closes panel when user navigates
              />
            ))}
